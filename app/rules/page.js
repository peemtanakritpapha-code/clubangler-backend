    ...
    <div style={{ minHeight: "100vh", background: C.bg, padding: "24px 16px" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 14, padding: "26px 24px", marginTop: 12, boxShadow: "0 4px 16px rgba(0,0,0,.05)" }}>
          ...
          <Callout variant="pending">🔶 ใช้กติกานี้ไปก่อน — รายละเอียดเพิ่มเติม (เช่น กรณีตรวจพบว่าผู้ขายจงใจส่งกล่องเปล่า) อยู่ระหว่างรอเคาะ</Callout>
          ...
          <Callout variant="pending">🔶 รายละเอียดขั้นตอนเต็มของเคสนี้ (ทั้งฝั่งผู้ซื้อและกรณีของคืนหายระหว่างส่งกลับ) อยู่ระหว่างออกแบบ จะอัปเดตหน้านี้อีกครั้งเมื่อเคาะขั้นตอนเรียบร้อย</Callout>
