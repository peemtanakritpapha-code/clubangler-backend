# patch-dispute2a-admin-v2.py — ขยายกล่อง snapshot ให้ครบเหมือนดูโพสต์จริง (รูปครบทุกใบ + คำอธิบายเต็ม + หมวดหมู่)
# แทนที่กล่องสรุปย่อเดิม (DISPUTE-2a-ADMIN) ทั้งก้อน
# รันจาก root: python patch-dispute2a-admin-v2.py
import io

PATH = "app/admin/AdminClient.js"
MARKER = "DISPUTE-2a-ADMIN-V2"
...
'              )}'
    ...
    n = s.count(old)
    assert n == 1, "ANCHOR ERROR: found %d of old snapshot box — STOP" % n

    new = (
'              {/* ' + MARKER + ': \u0e40\u0e2b\u0e21\u0e37\u0e2d\u0e19\u0e14\u0e39\u0e42\u0e1e\u0e2a\u0e15\u0e4c\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32\u0e08\u0e23\u0e34\u0e07 \u2014 \u0e23\u0e39\u0e1b\u0e04\u0e23\u0e1a + \u0e04\u0e33\u0e2d\u0e18\u0e34\u0e1a\u0e32\u0e22\u0e40\u0e15\u0e47\u0e21 + \u0e2b\u0e21\u0e27\u0e14\u0e2b\u0e21\u0e39\u0e48 */}' + EOL +
'              {o.product_snapshot ? (' + EOL +
...
'              )}'
    ...
    s = rep(s, old, new, "expand snapshot box")
    bal(new)
    write(PATH, s)
